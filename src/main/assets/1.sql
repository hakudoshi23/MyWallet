...
CREATE TABLE move (
  ...
  FOREIGN KEY (account_id) REFERENCES account (_id) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (tag_id) REFERENCES tag (_id) ON DELETE SET NULL ON UPDATE CASCADE
);
